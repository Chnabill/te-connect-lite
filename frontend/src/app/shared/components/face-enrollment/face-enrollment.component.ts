  ...
  template: `
    <div class="face-enrollment-container">
      <div class="enrollment-header">
        <h3 class="text-lg font-semibold text-gray-800 mb-2">Face Recognition Enrollment</h3>
        <p class="text-sm text-gray-600">Capture your face to enable quick login</p>
      </div>
...
export class FaceEnrollmentComponent implements OnDestroy {
  @ViewChild('video') video!: ElementRef<HTMLVideoElement>;
  
  @Output() faceEnrolled = new EventEmitter<string>();
  ...
  confirmPhoto() {
    if (this.capturedImage) {
      this.faceEnrolled.emit(this.capturedImage);
